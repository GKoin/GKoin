...
uint256 hashGenesisBlock("0x0eeb71642402fee68b38e7f67b7f40a79610361d2f093043170a5e30d60f9ca3");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "End Poverty by 2024";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("fa6892e517aedf1f48a21d48ce4b7a054c8d110c8ff8670d3865c2c0a2b8a33d"));
        block.print();
